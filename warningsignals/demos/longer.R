...
social_plot(plot(tau_var), file="taudist_var.png", tags="warningsignals stochpop tau var simulation", comment="N=50, T=100, R=5-0.015*t", mention="cboettig")
social_plot(plot(tau_acor), file="taudist_acor.png", tags="warningsignals stochpop tau acor simulation", comment="N=50, T=100, R=5-0.015*t")
