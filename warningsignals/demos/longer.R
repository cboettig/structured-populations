...
X <- simulateGauss(timedep_LTC, pars, N=500, T=500, Xo=100)
...
social_plot(plot(tau_var), file="taudist_var.png", tags="warningsignals stochpop tau var simulation", comment="N=500, T=500, R=5-0.015*t", mention="cboettig")
social_plot(plot(tau_acor), file="taudist_acor.png", tags="warningsignals stochpop tau acor simulation", comment="N=500, T=500, R=5-0.015*t")
...
save(list=ls(), file="longer.Rdat")
social_plot(plot(out), file="longer_mc.png", tag="warningsignal stochpop LTC, simulation", comment="N=500, T=500, R=5- 0/05*t")
