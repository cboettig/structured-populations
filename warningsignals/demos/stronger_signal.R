...
X <- simulateGauss(timedep_LTC, pars, N=2500, T=500, Xo=100)
...
save(list=ls(), file="stronger_signal.Rdat")
social_plot(plot(tau_var), file="taudist_var.png", tags="warningsignals stochpop tau var simulation", comment="N=2500, T=500, R=5-0.015*t", mention="cboettig")
social_plot(plot(tau_acor), file="taudist_acor.png", tags="warningsignals stochpop tau acor simulation", comment="N=2500, T=500, R=5-0.015*t")
...
save(list=ls(), file="stronger_signal.Rdat")
social_plot(plot(out), file="stronger_signal_mc.png", tag="warningsignal stochpop LTC, simulation", comment="N=2500, T=500, R=5- 0/05*t")
